...
전진종종걸음a_3:
    ...
    GOSUB 앞뒤기울기측정
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 보행횟수 THEN  GOTO 전진종종걸음_멈춤a
    'ERX 4800,A, 전진종종걸음_4
    'IF A <> A_old THEN  GOTO 전진종종걸음_멈춤
...
바닥보고종종걸음a_3:
    ...
    GOSUB 앞뒤기울기측정
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 보행횟수 THEN  GOTO 바닥보고종종걸음_멈춤a
    'ERX 4800,A, 전진종종걸음_4
    'IF A <> A_old THEN  GOTO 전진종종걸음_멈춤
